...
var order = (function($) {
        ...
        var $item = ui.$delivery.btn.filter(':checked'),
            ...
            alert =
                freeDelivery.enabled
                    ...
                    :
                        'Shipping amount ' + deliverySumma + ' dollar ' +
                        'the total amount of the order: ' +
                        cartSumma + ' + ' + deliverySumma + ' = ' + fullSumma + ' dollar';
    ...
    function _orderComplete() {
        ui.$orderBtn.removeAttr('disabled').text('Send an order');
    }
    ...
    function _onSubmitForm(e) {
        ...
        ui.$orderBtn.attr('disabled', 'disabled').text('Sending order...');
        $.ajax({
